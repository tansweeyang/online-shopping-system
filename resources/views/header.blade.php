                        ...
                        @if (session()->has('uid'))
                            ...
                            <div class="dropdownn">
                                ...
                                <div class="dropdownn-content">
                                    <a href="" data-toggle="modal" data-target="#profile"><i
                                            class="fa fa-user-circle" aria-hidden="true"></i>My Profile</a>
                                    <a href="{{ url('logout') }}"><i class="fa fa-sign-in" aria-hidden="true"></i>Log
                                        out</a>
                                </div>
                            </div>
                        @else
                            <div class="dropdownn">
                                ...
                                <div class="dropdownn-content">
                                    <a href="{{ url('admin/login') }}"><i class="fa fa-user"
